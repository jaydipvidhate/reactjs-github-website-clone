...
const Comunity = () => {
    return(
        <div id="community" className="contactClass" style={{display: 'flex',justifyContent:'space-around',padding: "100px 20px"}}>
        <a style={{marginRight:200,marginLeft: 60,fontSize:30,letterSpacing: -1,fontWeight:700}} href="#banner">GitHub</a>
        <div style={{display: 'flex',flexDirection:'column'}}>
          <p style={{color: COLORS.black,letterSpacing: 1.5,padding: "5px 0",opacity: 0.9,fontSize: 15}}>
          Product
          </p>
