  ...
  >
    ...
    >
      <div>
        ...
        >
          Millions of developers and companies build, ship, and meintain
          their software on GitHub-the largest and most advances
      ...
      <img src={Globe} style={{ width: 800, height: 650,position: 'absolute',right: -100,top :"auto"}} />
    </div>
    <div
      className="container"
      style={{
